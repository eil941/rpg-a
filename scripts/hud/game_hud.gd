...
func rebuild_effect_bar() -> void:
	...
	for entry in effect_entries:
		...
		if texture != null:
			...
			icon_button.mouse_entered.connect(_on_effect_icon_mouse_entered.bind(icon_button, tooltip_text, hover_key))
			icon_button.mouse_exited.connect(_on_effect_icon_mouse_exited.bind(icon_button))
			icon_button.gui_input.connect(_on_effect_icon_gui_input.bind(icon_button, tooltip_text, hover_key))
